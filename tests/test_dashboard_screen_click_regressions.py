...
def test_dashboard_screen_uses_a_hidden_responsive_context_drawer() -> None:
    ...
    assert '<div class="ops-main" id="workspaceMain" tabindex="-1">' in html
...
def test_sensor_device_table_does_not_collapse_or_clip_at_scale() -> None:
    ...
    assert 'aria-label="서버와 현장 엣지 노드 목록"' in html
    assert 'id="inventoryTitle">노드 목록<' in html
    assert 'id="sensorInventorySections"' in html
