...
PUBLICATION_SECTIONS = [
    ...
    ("개발 참고", "reference", [
        ...
        "Llama-장비별-GPU-성능측정.md",
        "2026-09-10-다중모델-3장비-실험결과.md",
        "2026-09-08-Nano-AGX-서비스-연속성-실험결과.md",
...
DISPLAY_TITLES = {
    ...
    "Llama-오프로딩-부하-판단-기준.md": "Llama 오프로딩 부하 판단 기준 — 실제 Orin Nano GPU 시험",
    "Llama-장비별-GPU-성능측정.md": "Llama 장비별 GPU 성능측정",
    "2026-09-10-다중모델-3장비-실험결과.md": "다중 모델 성능측정 기술 메모(TM) — Orin Nano·AGX Orin·DGX Spark",
    "문서-안내.md": "문서 안내",
