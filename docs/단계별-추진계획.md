...
실제 증가 raw origin의 live inference/central readback과 browser panel은 통과했다. 다음 검증은
실제 장치 움직임 anomaly 현장 시연과 장치 분리·복구다. Modbus, OPC-UA,
다른 I2C 장비·주소와 RTSP workflow는 protocol별 migration gate 전까지 완료로 주장하지 않는다.
