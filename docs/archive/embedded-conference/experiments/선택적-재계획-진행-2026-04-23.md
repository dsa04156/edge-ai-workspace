...
> 상태: 보관 문서. 현재 PoC 운영·구현 기준이 아니며 과거 선택적 재계획 실험 기록으로만 보존한다.
...
- [engine.py](../../../../edge-orch/placement_engine/placement_engine/engine.py)
- [models.py](../../../../edge-orch/placement_engine/placement_engine/models.py)
- [service.py](../../../../edge-orch/placement_engine/placement_engine/service.py)
...
- [models.py](../../../../edge-orch/state-aggregator/app/models.py)
- [storage.py](../../../../edge-orch/state-aggregator/app/storage.py)
- [main.py](../../../../edge-orch/state-aggregator/app/main.py)
- [service.py](../../../../edge-orch/state-aggregator/app/service.py)
...
- [models.py](../../../../edge-orch/workflow_executor/workflow_executor/models.py)
- [service.py](../../../../edge-orch/workflow_executor/workflow_executor/service.py)
...
- [run_minimal_latency_experiment.py](run_minimal_latency_experiment.py)
