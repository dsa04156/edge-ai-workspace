...
> 상태: 보관 문서. 현재 PoC 운영·구현 기준이 아니며 과거 통합 상세 기록으로만 보존한다.
...
원본 문서:
- `AGENTS.md`
- `docs/archive/legacy-orchestration/시스템-개요.md`
- `docs/archive/legacy-orchestration/아키텍처.md`
- `docs/archive/research/연구-주제.md`
- `docs/archive/research/논문-전략.md`
- `docs/archive/research/투고처-전략.md`
- `docs/archive/research/평가-계획.md`
- `docs/archive/research/논문-작성-점검표.md`
...
- 이 archive의 stage-level placement / runtime replanning 문맥에서 HAMi는 GPU stage 배치 실험을 위한 자원 공유 계층으로 볼 수 있다. 다만 HAMi 설치 자체가 runtime replanning 기능 완성을 의미하지 않으며, 현재 활성 PoC에서는 `docs/ops/gpu-hami-런타임-운영.md`의 운영 메모처럼 GPU runtime 보조/관측 기반으로 다룬다.
...
- [scripts/check-worker-node-join.sh](../../../edge-orch/scripts/check-worker-node-join.sh)
- [docs/ops/노드-조인-점검.md](../../ops/노드-조인-점검.md)
- [scripts/check-edgecore-node.sh](../../../edge-orch/scripts/check-edgecore-node.sh)
- [docs/ops/엣지-노드-조인-점검.md](../../ops/엣지-노드-조인-점검.md)
- [scripts/check-pod-connectivity.sh](../../../edge-orch/scripts/check-pod-connectivity.sh)
- [docs/ops/파드-연결성-점검.md](../../ops/파드-연결성-점검.md)
