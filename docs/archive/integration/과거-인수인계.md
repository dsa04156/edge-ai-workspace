...
> 상태: 보관 문서. 현재 PoC 운영·구현 기준이 아니며 과거 인수인계 내용의 재현 근거로만 보존한다.
...
기준 소스:
- [mappers/mqttvirtual](../../../mappers/mqttvirtual)
...
핵심 파일:
- [mappers/mqttvirtual/device/device.go](../../../mappers/mqttvirtual/device/device.go)
- [mappers/mqttvirtual/device/devicetwin.go](../../../mappers/mqttvirtual/device/devicetwin.go)
- [mappers/mqttvirtual/device/devicestatus.go](../../../mappers/mqttvirtual/device/devicestatus.go)
- [mappers/mqttvirtual/driver/driver.go](../../../mappers/mqttvirtual/driver/driver.go)
- [mappers/mqttvirtual/config.yaml](../../../mappers/mqttvirtual/config.yaml)
...
기준 경로:
- [edge-device/models](../../../edge-device/models)
- `edge-device/devices.yaml` (과거 파일, 현재 저장소에는 없음)
- [edge-device/scripts/generate_devices.py](../../../edge-device/scripts/generate_devices.py)
- [edge-device/scripts/deploy.sh](../../../edge-device/scripts/deploy.sh)
...
- [mappers/script/test_device.py](../../../mappers/script/test_device.py)
...
상세 경과 정리:
- [docs/문서-안내.md](../../문서-안내.md)
- [docs/archive/integration/통합-문서.md](통합-문서.md)
