...
> 상태: 보관 문서. 현재 PoC 운영·구현 기준이 아니며 레거시 오케스트레이션 참고 자료로만 보존한다.
...
- 진행/실험 결과: `선택적-재계획-진행-2026-04-23.md`
- 연구 방향/메시지: `docs/archive/research/연구-주제.md`, `docs/archive/research/논문-전략.md`
