...
- `docs/second-year-virtual-device-workflow-architecture.md`
...
2차년도 설계 트랙에서 다시 다루는 경우에는 `docs/second-year-virtual-device-workflow-architecture.md`의 정의와 경계를 따른다.
