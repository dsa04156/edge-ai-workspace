module github.com/dsa04156/edge-ai-workspace/edgex/device-sensehat

go 1.25.0

require (
	github.com/dsa04156/edge-ai-workspace/edgex/local-data-cache v0.0.0
...
replace github.com/dsa04156/edge-ai-workspace/edgex/local-data-cache => ../local-data-cache
