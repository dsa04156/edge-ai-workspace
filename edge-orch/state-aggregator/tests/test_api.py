...
def test_removed_virtual_device_and_resource_pool_routes_are_not_registered():
    with TestClient(app) as client:
        responses = [
            client.get("/state/virtual-devices"),
            client.get("/state/virtual-resources"),
            client.get("/state/resource-pool"),
            client.post("/state/resource-pool/plan", json={}),
        ]
