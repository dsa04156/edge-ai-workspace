...
```bash
python3 /home/etri/jinuk/edgeAI/scripts/generate_devices.py > /home/etri/jinuk/edgeAI/devices.yaml
```

## Apply Models

```bash
kubectl apply -f /home/etri/jinuk/edgeAI/models/
```

## Apply Devices

```bash
kubectl apply -f /home/etri/jinuk/edgeAI/devices.yaml
```
...
```bash
kubectl apply -f /home/etri/jinuk/edgeAI/k8s/
```
